class PagesController < ApplicationController
  skip_before_action :authenticate_user!, only: [:home, :details_tarifs, :mentions_legales, :nous_decouvrir, :fiches_pratiques, :statut_auto_entrepreneur, :new, :create, :reponse_contactez_nous, :charges_deductibles, :recommandation]
