...
deux mois de loyers hors charges] :"
    ...
    if @contrat.locataire_candidature.annonce.meublé == "Meublé"
      @contrat.depot_garantie = (@locataire_candidature.annonce.loyer_mensuel - @locataire_candidature.annonce.charges)*2
    else
